...
const presetTrainers = {
  ahmad: {
    ...
    degreeSpecialization: 'Software Engineering',
    graduationYear: '2016',
    degreeCertificateNumber: 'AZU-BSC-SE-2016-1042',
    degreeCertificate: { name: 'Bachelor_Degree_Certificate.pdf', size: '1.2 MB', verified: true },
    employeeId: 'AZU-ENG-1042',
    nationalId: '408123482',
    status: 'active',
  ...
  sara: {
    ...
    jobTitle: 'Mobile Engineering Lecturer',
    ...
    graduationYear: '2018',
    degreeCertificateNumber: 'AZU-MSC-CE-2018-1187',
    degreeCertificate: { name: 'Master_Degree_Certificate.pdf', size: '1.4 MB', verified: true },
    employeeId: 'AZU-ENG-1187',
    nationalId: '409781226',
    status: 'active',
...
const buildDefaultTrainer = (email) => {
  ...
  return {
    ...
    degreeSpecialization: 'Not specified',
    graduationYear: '',
    degreeCertificateNumber: 'Pending verification',
