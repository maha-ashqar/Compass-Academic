...
import { trainerLogin } from './api/trainerAuth';
...
const TrainerLogin = ({ onLogin }) => {
  ...
  return (
    <main className="trainer-auth-shell">
      <section
        className="trainer-auth-story"
        style={{
          '--trainer-hero': `url(${trainerHero})`,
        }}
        aria-label="Compass Academy trainer portal"
      >
        <button
          type="button"
          className="trainer-auth-brand"
          onClick={() => navigate('/')}
        ...
        <div className="trainer-auth-portal-badge">
          <span /> TRAINER PORTAL
        </div>
        ...
        <div className="trainer-auth-story-copy">
          ...
          <p>
            Manage courses, review student work, and provide
            the guidance that turns learning into progress.
          </p>
        ...
        <small>
          © {new Date().getFullYear()} Compass Academy · Independent learning platform
        </small>
      </section>
      ...
      <section className="trainer-auth-panel">
        ...
        <div className="trainer-auth-content">
          <div className="trainer-auth-heading-badge">
            <span /> TRAINER SIGN IN
          </div>

          <h2>Welcome back</h2>

          <p className="trainer-auth-lead">
            Sign in to manage your courses and students.
          </p>

          <form
            className="trainer-auth-form"
          ...
          >
            ...
            >
              ...
              {isSubmitting ? (
                <span
                  className="trainer-auth-spinner"
                  aria-hidden="true"
                />
              ) : (
                <FiArrowRight />
          ...
          <div className="trainer-auth-divider">
            <span>OR SIGN IN WITH</span>
          </div>

          <button
            type="button"
            className="trainer-auth-google"
          ...
          <div className="trainer-auth-apply">
            <div>
              ...
              <span>
                Submit your trainer profile for review.
              </span>
            </div>
          ...
          <div className="trainer-auth-secure">
            <span /> Secure trainer access · Protected workspace
          </div>

          <nav
            className="trainer-auth-legal"
