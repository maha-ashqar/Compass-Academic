...
function LoginPage({ onLogin }) {
  ...
  const handleLogin = async (event) => {
    ...
    try {
      ...
      const data = await studentLogin(cleanEmail, password);

      // Remove any previous student token
      ...
      // Keep the current App.jsx flow working for now
      if (onLogin) {
  ...
  return (
    <main className="student-login-page">
      ...
      <section className="student-login-visual">
        <img
          src={heroImg}
          alt="Students collaborating on their academic projects"
        />
      ...
      <section className="student-login-panel">
        ...
        <div className="student-login-content">
          ...
          <div className="student-legal-links">
