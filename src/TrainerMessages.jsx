...
const autoReplies = [
  ...
  'Sure, sounds good.',
  'I will review your submission shortly.',
];
...
const TrainerMessages = () => {
  const { conversations, sendMessage, receiveAutoReply, clearConversation, toggleBlock } = useTrainerMessages();
      ...
      <div className="messages-shell">
        ...
        <aside className="details-panel">
          ...
          <div className="details-section">
            <span className="details-section-label">Student Details</span>
